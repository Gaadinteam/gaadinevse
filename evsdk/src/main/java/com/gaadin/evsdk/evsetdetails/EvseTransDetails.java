...
public class EvseTransDetails {
    ...
    public EvseTransDetails(InterfaceEvseTransFetech listener, int requestTag, String urls, Context context, String jwt, String transID) {
        onListerner = listener;
        requestMethod = Request.Method.GET;
        this.context = context;
        this.jwt=jwt;

        fetchJSONDataFromWebService(urls+"/charging/secure/api/v1/charging_start?charging_id="+transID, null, requestTag);
    }
