...
public class EvseStop {
    private InterfaceEvsestop onListerner;
    private int requestMethod;
    private Context context;
    private String jwt ;
    private RequestQueue requestQueue;

    public EvseStop(InterfaceEvsestop listener, int requestTag, String urls, Context context, String jwt, String transID) {
        onListerner = listener;
        requestMethod = Request.Method.GET;
        this.context = context;
        this.jwt=jwt;

        fetchJSONDataFromWebService(urls+"/charging/secure/api/v1/charging_stop?charging_id="+transID, null, requestTag);
    }
    ...
    private void fetchJSONDataFromWebService(String URL, JSONObject jsonPayload, final int requestTag) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(requestMethod, URL, jsonPayload,
                ...
                response -> onListerner.evseStop(response, requestTag),
                error -> onListerner.evseStopOnError(error, requestTag)) {
